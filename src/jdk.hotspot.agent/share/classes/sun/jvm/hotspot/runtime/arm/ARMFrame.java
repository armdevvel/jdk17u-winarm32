...
/** Specialization of and implementation of abstract methods of the
    Frame class for the arm family of CPUs. */
...
public class ARMFrame extends Frame {
  ...
  private static VMReg fp = new VMReg(11 << 1);
  ...
  public ARMFrame(Address raw_sp, Address raw_unextendedSp, Address raw_fp, Address pc) {
    this.raw_sp = raw_sp;
    ...
    if (DEBUG) {
      System.out.println("ARMFrame(sp, unextendedSP, fp, pc): " + this);
      dumpStack();
    }
  ...
  public Frame sender(RegisterMap regMap, CodeBlob cb) {
    ...
    return new ARMFrame(getSenderSP(), getLink(), getSenderPC());
  }
  ...
  private Frame senderForEntryFrame(ARMRegisterMap map) {
    ...
    ARMJavaCallWrapper jcw = (ARMJavaCallWrapper) getEntryFrameCallWrapper();
    if (Assert.ASSERTS_ENABLED) {
    ...
    if (jcw.getLastJavaPC() != null) {
      fr = new ARMFrame(jcw.getLastJavaSP(), jcw.getLastJavaFP(), jcw.getLastJavaPC());
    } else {
      fr = new ARMFrame(jcw.getLastJavaSP(), jcw.getLastJavaFP());
    }
    map.clear();
    if (Assert.ASSERTS_ENABLED) {
  ...
  private Frame senderForInterpreterFrame(ARMRegisterMap map) {
    ...
    return new ARMFrame(sp, unextendedSP, getLink(), getSenderPC());
  }
  ...
  private Frame senderForCompiledFrame(ARMRegisterMap map, CodeBlob cb) {
    ...
    //
    // NOTE: some of this code is (unfortunately) duplicated  ARMCurrentFrameGuess
    //
    ...
    return new ARMFrame(senderSP, savedFPAddr.getAddressAt(0), senderPC);
  }
  ...
  public JavaCallWrapper getEntryFrameCallWrapper() {
    return new ARMJavaCallWrapper(addressOfStackSlot(ENTRY_FRAME_CALL_WRAPPER_OFFSET).getAddressAt(0));
  }
