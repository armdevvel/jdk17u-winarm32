...
#ifndef OS_CPU_WINDOWS_ARM_THREAD_WINDOWS_ARM_HPP
#define OS_CPU_WINDOWS_ARM_THREAD_WINDOWS_ARM_HPP
...
public:
  ...
  static Thread *arm_get_thread_helper() {
     return Thread::current();
  }

#endif // OS_CPU_WINDOWS_ARM_THREAD_WINDOWS_ARM_HPP
